...
var rconf = require('../node_modules/sails/lib/app/configuration/rc');
var package = require('../node_modules/sails/package');
...
module.exports = function() {
    ...
    var cmds = cliArguments.pop();

    if (cmds.base && cmds.base !== 'sails') {
        console.error('Only sails is supported currently.');
        return;
    }
    ...
    return sailsgen(scope, {
        success: function() {
            ncp(src, dest, function(err) {
                ...
                console.log('Created a new Sails app %s', cliArguments[0]);
            })
        }
    });
};